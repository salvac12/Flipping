...
async function main() {
  ...
  const reformCosts = [
    // REFORMA INTEGRAL - BASIC
    {
      ...
      zone: null,
      reformType: ReformType.INTEGRAL,
      quality: ReformQuality.BASIC,
      costPerM2: 600,
      minCost: 50000,
      maxCost: null,
      includesItems: [
    ...
    // REFORMA COSMÉTICA - BASIC
    {
      ...
      zone: null,
      reformType: ReformType.COSMETIC,
      quality: ReformQuality.BASIC,
      costPerM2: 150,
      minCost: 8000,
      maxCost: 20000,
    ...
    // REFORMA ESTRUCTURAL
    {
      ...
      zone: null,
      reformType: ReformType.STRUCTURAL,
      quality: ReformQuality.BASIC,
      costPerM2: 400,
      minCost: 40000,
      maxCost: null,
  ...
  for (const cost of reformCosts) {
    await prisma.reformCost.upsert({
      where: {
        id: `${cost.reformType}_${cost.quality}_${cost.zone || 'GENERAL'}`,
      },
      update: {},
      create: cost,
    });
